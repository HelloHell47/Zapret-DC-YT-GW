...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,6112 --wf-udp=443,19294-19344,50000-50100 ^
--filter-tcp=443 --ipset-ip=37.157.242.27 --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=664 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%BIN%stun.bin" --dpi-desync-fake-tls="%BIN%tls_clienthello_max_ru.bin" --dpi-desync-fake-http="%BIN%tls_clienthello_max_ru.bin" --new ^
--filter-tcp=443 --hostlist-domains=ncplatform.net,privacy.xboxlive.com,guildwars2.com,staticwars.com,catalog.gamepass.com --dpi-desync=hostfakesplit --dpi-desync-fooling=ts,md5sig --dpi-desync-autottl=2 --dpi-desync-repeats=4 --dpi-desync-hostfakesplit-mod=host=reddit.com --new ^
--filter-tcp=443 --ipset-ip=104.21.26.0/24,172.67.0.0/16,4.225.11.0/24,185.199.108.0/24,35.156.125.0/24 --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=reddit.com --dpi-desync-fooling=ts --new ^
--filter-tcp=80 --hostlist-domains=assetcdn.101.ArenaNetworks.com --dpi-desync=fake --dpi-desync-fake-http="%BIN%tls_clienthello_4pda_to.bin" --dpi-desync-fooling=ts --dpi-desync-cutoff=d2 --new ^
--filter-tcp=6112 --dpi-desync=fake --dpi-desync-fake-unknown="%BIN%tls_clienthello_4pda_to.bin" --dpi-desync-any-protocol --dpi-desync-fooling=badseq --dpi-desync-repeats=1 --dpi-desync-cutoff=d3 --new ^
