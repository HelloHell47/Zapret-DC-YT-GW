...
--filter-tcp=443 --hostlist-domains=ncplatform.net,privacy.xboxlive.com,guildwars2.com,staticwars.com,catalog.gamepass.com,s3.amazonaws.com --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=reddit.com --dpi-desync-fooling=ts --new ^
...
--filter-tcp=6112 --ipset="%LISTS%gw.txt" --dpi-desync=multisplit --dpi-desync-split-pos=1 --dpi-desync-split-seqovl=582 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_11.bin" --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fooling=ts --new ^
