...
--filter-tcp=443 --hostlist-domains=ncplatform.net,privacy.xboxlive.com,guildwars2.com,staticwars.com,catalog.gamepass.com --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=reddit.com --dpi-desync-fooling=ts --new ^
