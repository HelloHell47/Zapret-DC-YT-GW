...
--filter-tcp=443 --hostlist-domains=ncplatform.net,privacy.xboxlive.com,guildwars2.com,staticwars.com,catalog.gamepass.com,ua.ncsoft.com,s3.amazonaws.com --dpi-desync=fake,fakedsplit --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --new ^
...
--filter-tcp=6112 --ipset="%LISTS%gw.txt" --dpi-desync=fake --dpi-desync-fake-unknown="%BIN%tls_clienthello_4pda_to.bin" --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fooling=ts --new ^
