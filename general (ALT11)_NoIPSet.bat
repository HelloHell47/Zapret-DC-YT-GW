...
--filter-tcp=6112 --dpi-desync=fake --dpi-desync-fake-unknown="%BIN%tls_clienthello_11.bin" --dpi-desync-any-protocol --dpi-desync-fooling=badseq --dpi-desync-repeats=1 --dpi-desync-cutoff=d3 --new ^
