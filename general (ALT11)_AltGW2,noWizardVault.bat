...
--filter-tcp=443 --ipset-ip=104.21.26.0/24,172.67.0.0/16,4.225.11.0/24,185.199.108.0/24,35.156.125.0/24,37.157.242.27 --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=reddit.com --dpi-desync-fooling=ts --new ^
...
--filter-tcp=6112 --ipset="%LISTS%gw.txt" --dpi-desync=fake --dpi-desync-fake-unknown="%BIN%tls_clienthello_11.bin" --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fooling=ts --new ^
