...
--filter-tcp=6112 --ipset="%LISTS%gw.txt" --dpi-desync=multisplit --dpi-desync-split-pos=1 --dpi-desync-split-seqovl=582 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_4pda_to.bin" --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fooling=ts --new ^
